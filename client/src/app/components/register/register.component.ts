...
export class RegisterComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.age = new FormControl('', [<any>Validators.required]);
    this.country = new FormControl('', [<any>Validators.required]);
  ...
  onSubmit() {
    const user = new User(this.myForm.value.email, this.myForm.value.password,this.myForm.value.name,this.myForm.value.age,this.myForm.value.country, this.myForm.value.contact);
